...
// Skill settings.
//-----------------------------------------------------------------------------
ConVar	sk_headcrab_health( "sk_headcrab_health","5");
ConVar	sk_headcrab_fast_health( "sk_headcrab_fast_health","5");
ConVar	sk_headcrab_poison_health( "sk_headcrab_poison_health","15");
